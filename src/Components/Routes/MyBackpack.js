              ...
              <div className="row mx-0">
                <div className="col-12 col-md-4 mt-3 mx-auto px-1">
                  ...
                  <div className="card-header mb-1 pb-2 highlight-divs">
                    <span className="mb-0 ">
                      <p className="mb-0 mt-2 FS-18 Bold mx-3">My Comments</p>
                    </span>
                  </div>
                  ...
                  <div class="comments card SideCard py-4 px-5 mb-3">
                    ...
                    >
                      <p className="Bold mb-0" style={{ cursor: "pointer" }}>
                        load More
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="card-header mb-1 pb-2 highlight-divs">
                    <span className="mb-0 ">
                      <p className="mb-0 mt-2 FS-18 Bold mx-3">My Classrooms</p>
                    </span>
                  </div>
