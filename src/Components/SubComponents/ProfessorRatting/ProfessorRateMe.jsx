                ...
                <div className="col-11 col-md-10 mx-auto space-between">
                  <form onSubmit={this.handleSubmit}>
                    <div className="row col-12 col-md-8 col-lg-6 mx-auto bg-white ShadowBordr Round25 p-4">
                      <div className="col-12 FS_18 Bold ">
                          ...
                          {this.state.teachingstyle.map((each) => {
                            return (
                              <li className="col-4 col-md-3  px-1 text-center">
                                ...
                                />
                                <label
                                  className="w-100 py-1 FS_12 text-center"
                                  htmlFor={each.name}
                                >
                                  {each.name}
                                </label>
                      ...
                      <div className="row col-12 px-0 mt-3">
                        <div className="col-12 col-sm-6  borderRight">
                          <h5>Attandance</h5>
                      ...
                      <div className="col-12  px-0 RadioToButton Tags">
                        ...
                        <div className="row">
                          <div className=" ">
                            ...
                            />
                            <label
                              className="yes-no-radiobtn py-1 px-3 FS_10 text-center"
                              htmlFor="Yes"
                            >
                              Yes
                            </label>
                      ...
                      <div class="col-12 form-group mx-auto mb-4 px-0">
                        <button
                          className=" w-100 button border-0 filled_btn py-2"
                          type="Submit"
                        >
                          Submit
                        </button>
